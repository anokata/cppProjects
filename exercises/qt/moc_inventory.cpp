...
static const char qt_meta_stringdata_Inventory[] = {
    "Inventory\0"
};
...
const QMetaObjectExtraData Inventory::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Inventory::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Inventory,
      qt_meta_data_Inventory, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Inventory::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Inventory))
